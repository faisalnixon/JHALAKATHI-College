  ...
  return (
    <div className="mx-auto w-[96%] py-10 md:py-14">
      <div className="mb-10 text-center md:mb-14">
        <span className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
          <Users className="h-8 w-8 text-primary" fill="currentColor" />
        </span>
        ...
        <p className="mx-auto mt-2 max-w-2xl font-body-md text-body-md text-on-surface-variant">
          Bangladesh National Cadet Corps unit of Jhalakathi Government Women's
          College.
        </p>
      </div>
