      ...
      <header className="sticky top-0 z-50 flex w-full items-center justify-between border-b border-border-neutral bg-surface/95 px-4 py-3 backdrop-blur-sm md:px-8 lg:px-16">
        ...
        <nav className="hidden items-center gap-8 lg:flex">
          ...
          <button
            ...
            className="menu-button flex cursor-pointer items-center gap-2 rounded-full bg-primary px-6 py-2 font-label-md text-label-md font-bold text-on-primary"
          >
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <button
            type="button"
            onClick={() => setMenuOpen(true)}
            className="menu-button flex cursor-pointer items-center gap-2 rounded-full bg-primary px-4 py-2 font-label-md text-label-md font-bold text-on-primary"
          >
            <Menu className="h-5 w-5" />
            <span>মেনু</span>
          </button>
